...
,
  Gampaha: [
    ...
    "Ganemulla", "Nittambuwa", "Kelaniya", "Piliyandala"
  ],
  Kalutara: [
  ...
  // Southern Province
  Galle: [
    "Galle", "Hikkaduwa", "Unawatuna", "Ambalangoda", "Ambalangoda", "Bentota (border)",
  ...
  Puttalam: [
    "Puttalam", "Chilaw", "Wennappuwa", "Marawila", "Mundel (Mundalama)", "Kalpitiya",
